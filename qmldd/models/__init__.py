...
from .quantum import QuantumKernelSVM, VariationalQuantumClassifier, QuantumNeuralNetwork
...
MODEL_REGISTRY: dict[str, Callable[..., BaseModel]] = {
    ...
    "quantum_qnn": lambda n_qubits, **kw: QuantumNeuralNetwork(n_qubits=n_qubits, **kw),
}

__all__ = ["BaseModel", "MODEL_REGISTRY", "QuantumNeuralNetwork", "QuantumKernelSVM", "VariationalQuantumClassifier"]
